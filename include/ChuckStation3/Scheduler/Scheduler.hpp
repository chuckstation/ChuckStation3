...
// Scheduler class ported from ChuckStation (rewrite)
...
public:
    ...
    struct Event {
        Event(std::function<void(void)> func, u64 time, u64 id, std::string name = "Unnamed")
            : func(func), time(time), id(id), name(name) {}
