...
static constexpr u64 SPU_LS_SIZE            = 256_KB;
static constexpr u64 RAW_SPU_MEM_START      = 0xE0000000;
static constexpr u64 RAW_SPU_OFFSET         = 0x100000;
static constexpr u64 RAW_SPU_PROBLEM_OFFSET = 0x40000;
