...
public:
    ...
    // When running functions via ppu->runFunc, the PPU state for the current running thread will be saved here and
    // restored later.
    ...
    enum class ThreadStatus { Running, Sleeping, Waiting, Terminated };
