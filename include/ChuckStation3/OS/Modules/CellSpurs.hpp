    ...
    std::string requestToString(s32 request) {
        switch (request) {
            case SPURS_TASKSET_REQUEST_POLL_SIGNAL:
                return "SPURS_TASKSET_REQUEST_POLL_SIGNAL";
                break;
            case SPURS_TASKSET_REQUEST_DESTROY_TASK:
                return "SPURS_TASKSET_REQUEST_DESTROY_TASK";
                break;
            case SPURS_TASKSET_REQUEST_YIELD_TASK:
                return "SPURS_TASKSET_REQUEST_YIELD_TASK";
                break;
            case SPURS_TASKSET_REQUEST_WAIT_SIGNAL:
                return "SPURS_TASKSET_REQUEST_WAIT_SIGNAL";
                break;
            case SPURS_TASKSET_REQUEST_POLL:
                return "SPURS_TASKSET_REQUEST_POLL";
                break;
            case SPURS_TASKSET_REQUEST_WAIT_WKL_FLAG:
                return "SPURS_TASKSET_REQUEST_WAIT_WKL_FLAG";
                break;
            case SPURS_TASKSET_REQUEST_SELECT_TASK:
                return "SPURS_TASKSET_REQUEST_SELECT_TASK";
                break;
            case SPURS_TASKSET_REQUEST_RECV_WKL_FLAG:
                return "SPURS_TASKSET_REQUEST_RECV_WKL_FLAG";
                break;
            default:
                return "UNKNOWN";
        }
