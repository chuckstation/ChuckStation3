...
public:
    ...
    enum VERTEX_SOURCE_TYPE { TEMP = 1, INPUT = 2, CONST = 3 };

    const std::string input_names[16] = {"vs_pos",
                                         "vs_weight",
                                         "vs_normal",
                                         "vs_diff_color",
                                         "vs_spec_color",
    ...
    const std::string output_names[16] = {"fs_pos",
                                          "fs_col0",
                                          "fs_col1",
                                          "fs_bfc0",
                                          "fs_bfc1",
    ...
    const u32 output_locations_map[16] = {0, 1, 2, 20, 21, 3, 22, 4, 5, 6, 7, 8, 9, 10, 11, 23};

    std::unordered_map<u8, std::string> vertex_vector_opcodes{
        {RSXVertex::VECTOR::NOP, "NOP"}, {RSXVertex::VECTOR::MOV, "MOV"}, {RSXVertex::VECTOR::MUL, "MUL"},
        {RSXVertex::VECTOR::ADD, "ADD"}, {RSXVertex::VECTOR::MAD, "MAD"}, {RSXVertex::VECTOR::DP3, "DP3"},
        {RSXVertex::VECTOR::DPH, "DPH"}, {RSXVertex::VECTOR::DP4, "DP4"}, {RSXVertex::VECTOR::DST, "DST"},
        {RSXVertex::VECTOR::MIN, "MIN"}, {RSXVertex::VECTOR::MAX, "MAX"}, {RSXVertex::VECTOR::SLT, "SLT"},
        {RSXVertex::VECTOR::SGE, "SGE"}, {RSXVertex::VECTOR::ARL, "ARL"}, {RSXVertex::VECTOR::FRC, "FRC"},
        {RSXVertex::VECTOR::FLR, "FLR"}, {RSXVertex::VECTOR::SEQ, "SEQ"}, {RSXVertex::VECTOR::SFL, "SFL"},
        {RSXVertex::VECTOR::SGT, "SGT"}, {RSXVertex::VECTOR::SLE, "SLE"}, {RSXVertex::VECTOR::SNE, "SNE"},
        {RSXVertex::VECTOR::STR, "STR"}, {RSXVertex::VECTOR::SSG, "SSG"}, {RSXVertex::VECTOR::TXL, "TXL"},
    };

    std::unordered_map<u8, std::string> vertex_scalar_opcodes{
        {RSXVertex::SCALAR::NOP, "NOP"}, {RSXVertex::SCALAR::MOV, "MOV"}, {RSXVertex::SCALAR::RCP, "RCP"},
        {RSXVertex::SCALAR::RCC, "RCC"}, {RSXVertex::SCALAR::RSQ, "RSQ"}, {RSXVertex::SCALAR::EXP, "EXP"},
        {RSXVertex::SCALAR::LOG, "LOG"}, {RSXVertex::SCALAR::LIT, "LIT"}, {RSXVertex::SCALAR::BRA, "BRA"},
        {RSXVertex::SCALAR::BRI, "BRI"}, {RSXVertex::SCALAR::CAL, "CAL"}, {RSXVertex::SCALAR::CLI, "CLI"},
        {RSXVertex::SCALAR::RET, "RET"}, {RSXVertex::SCALAR::LG2, "LG2"}, {RSXVertex::SCALAR::EX2, "EX2"},
        {RSXVertex::SCALAR::SIN, "SIN"}, {RSXVertex::SCALAR::COS, "COS"}, {RSXVertex::SCALAR::BRB, "BRB"},
        {RSXVertex::SCALAR::CLB, "CLB"}, {RSXVertex::SCALAR::PSH, "PSH"}, {RSXVertex::SCALAR::POP, "POP"},
    };
};
