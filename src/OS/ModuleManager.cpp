...
void ModuleManager::lle(u32 nid) {
    ...
    ps3->mem.watchpoints_r[ps3->ppu->state.lr + 4] =
        std::bind(&ModuleManager::printReturnValue, this, std::placeholders::_1);
    ...
    ps3->ppu->runFunc(
        ps3->mem.read<u32>(exports.funcs[nid].addr), ps3->mem.read<u32>(exports.funcs[nid].addr + 4), false);
}
...
bool ModuleManager::isForcedHLE(const u32 nid) {
    if (!import_map.contains(nid))
        ...
        return import_map[nid].force_hle;
}
...
void ModuleManager::init() {
    import_map = {
        ...
        {0x96328741,
         {"sysProcess_At_ExitSpawn", std::bind(&SysPrxForUser::sysProcess_At_ExitSpawn, &sysPrxForUser), true}},
        ...
        {0x06edea9e, {"cellGcmSetUserHandler", std::bind(&CellGcmSys::cellGcmSetUserHandler, &cellGcmSys)}},
        ...
        {0x5e2ee0f0,
         {"cellGcmGetDefaultCommandWordSize", std::bind(&CellGcmSys::cellGcmGetDefaultCommandWordSize, &cellGcmSys)}},
        {0x5a41c10f, {"cellGcmGetTimeStamp", std::bind(&ModuleManager::stub, this)}},
        {0x626e8518,
         {"cellGcmMapEaIoAddressWithFlags", std::bind(&CellGcmSys::cellGcmMapEaIoAddressWithFlags, &cellGcmSys)}},
        ...
        {0x8572bce2,
         {"cellGcmGetReportDataAddressLocation",
          std::bind(&CellGcmSys::cellGcmGetReportDataAddressLocation, &cellGcmSys)}},
        {0x8cdf8c70,
         {"cellGcmGetDefaultSegmentWordSize", std::bind(&CellGcmSys::cellGcmGetDefaultSegmentWordSize, &cellGcmSys)}},
        ...
        //{ 0xacee8542, { "cellGcmSetFlipImmediate",                          std::bind(&ModuleManager::stub, this) } },
        {0xb2e761d4, {"cellGcmResetFlipStatus", std::bind(&CellGcmSys::cellGcmResetFlipStatus, &cellGcmSys)}},
        {0xbc982946,
         {"cellGcmSetDefaultCommandBuffer", std::bind(&CellGcmSys::cellGcmSetDefaultCommandBuffer, &cellGcmSys)}},
        ...
        {0xd8f88e1a,
         {"_cellGcmSetFlipCommandWithWaitLabel",
          std::bind(&CellGcmSys::cellGcmSetFlip,
                    &cellGcmSys)}}, // TODO: I don't know what the "with wait label" part means
        ...
        {0x15b0b0cd,
         {"cellVideoOutGetConfiguration", std::bind(&CellVideoOut::cellVideoOutGetConfiguration, &cellVideoOut)}},
        {0x1e930eef, {"cellVideoOutGetDeviceInfo", std::bind(&CellVideoOut::cellVideoOutGetDeviceInfo, &cellVideoOut)}},
        {0x75bbb672,
         {"cellVideoOutGetNumberOfDevice", std::bind(&CellVideoOut::cellVideoOutGetNumberOfDevice, &cellVideoOut)}},
        ...
        {0xa322db75,
         {"cellVideoOutGetResolutionAvailability",
          std::bind(&CellVideoOut::cellVideoOutGetResolutionAvailability, &cellVideoOut)}},
        ...
        {0x02ff3c1b,
         {"cellSysutilUnregisterCallback", std::bind(&CellSysutil::cellSysutilUnregisterCallback, &cellSysutil)}},
        ...
        {0x40e895d3,
         {"cellSysutilGetSystemParamInt", std::bind(&CellSysutil::cellSysutilGetSystemParamInt, &cellSysutil)}},
        ...
        {0x938013a0,
         {"cellSysutilGetSystemParamString", std::bind(&CellSysutil::cellSysutilGetSystemParamString, &cellSysutil)}},
        {0x9d98afa0,
         {"cellSysutilRegisterCallback", std::bind(&CellSysutil::cellSysutilRegisterCallback, &cellSysutil)}},
        ...
        {0x112a5ee9,
         {"cellSysmoduleUnloadModule", std::bind(&CellSysmodule::cellSysmoduleUnloadModule, &cellSysmodule)}},
        ...
        {0xd1ca0503,
         {"cellRescVideoOutResolutionId2RescBufferMode",
          std::bind(&CellResc::cellRescVideoOutResolutionId2RescBufferMode, &cellResc)}},
        ...
        {0x07529113,
         {"cellSpursAttributeSetNamePrefix", std::bind(&CellSpurs::cellSpursAttributeSetNamePrefix, &cellSpurs)}},
        {0x1051d134,
         {"cellSpursAttributeEnableSpuPrintfIfAvailable",
          std::bind(&CellSpurs::cellSpursAttributeEnableSpuPrintfIfAvailable, &cellSpurs)}},
        {0x16394a4e,
         {"_cellSpursTasksetAttributeInitialize",
          std::bind(&CellSpurs::_cellSpursTasksetAttributeInitialize, &cellSpurs)}},
        {0x1656d49f,
         {"cellSpursLFQueueAttachLv2EventQueue",
          std::bind(&CellSpurs::cellSpursLFQueueAttachLv2EventQueue, &cellSpurs)}},
        {0x182d9890, {"cellSpursRequestIdleSpu", std::bind(&CellSpurs::cellSpursRequestIdleSpu, &cellSpurs)}},
        {0x1d46fedf,
         {"cellSpursCreateTaskWithAttribute", std::bind(&CellSpurs::cellSpursCreateTaskWithAttribute, &cellSpurs)}},
        {0x1f402f8f, {"cellSpursGetInfo", std::bind(&CellSpurs::cellSpursGetInfo, &cellSpurs)}},
        {0x30aa96c4,
         {"cellSpursInitializeWithAttribute2", std::bind(&CellSpurs::cellSpursInitializeWithAttribute2, &cellSpurs)}},
        {0x373523d4, {"cellSpursEventFlagWait", std::bind(&ModuleManager::stub, this)}},
        {0x4a5eab63,
         {"cellSpursWorkloadAttributeSetName", std::bind(&CellSpurs::cellSpursWorkloadAttributeSetName, &cellSpurs)}},
        ...
        {0x5ef96465,
         {"_cellSpursEventFlagInitialize", std::bind(&CellSpurs::_cellSpursEventFlagInitialize, &cellSpurs)}},
        {0x652b70e2,
         {"cellSpursTasksetAttributeSetName", std::bind(&CellSpurs::cellSpursTasksetAttributeSetName, &cellSpurs)}},
        {0x82275c1c,
         {"cellSpursAttributeSetMemoryContainerForSpuThread",
          std::bind(&CellSpurs::cellSpursAttributeSetMemoryContainerForSpuThread, &cellSpurs)}},
        {0x87630976,
         {"cellSpursEventFlagAttachLv2EventQueue",
          std::bind(&CellSpurs::cellSpursEventFlagAttachLv2EventQueue, &cellSpurs)}},
        {0x8a85674d, {"_cellSpursLFQueuePushBody", std::bind(&CellSpurs::_cellSpursLFQueuePushBody, &cellSpurs)}},
        {0x95180230,
         {"_cellSpursAttributeInitialize", std::bind(&CellSpurs::_cellSpursAttributeInitialize, &cellSpurs)}},
        {0x9dcbcb5d,
         {"cellSpursAttributeEnableSystemWorkload",
          std::bind(&CellSpurs::cellSpursAttributeEnableSystemWorkload, &cellSpurs)}},
        {0xa73bf47e,
         {"_cellSpursWorkloadFlagReceiver", std::bind(&CellSpurs::_cellSpursWorkloadFlagReceiver, &cellSpurs)}},
        {0xa839a4d9,
         {"cellSpursAttributeSetSpuThreadGroupType",
          std::bind(&CellSpurs::cellSpursAttributeSetSpuThreadGroupType, &cellSpurs)}},
        {0xaa6269a8,
         {"cellSpursInitializeWithAttribute", std::bind(&CellSpurs::cellSpursInitializeWithAttribute, &cellSpurs)}},
        {0xacfc8dbc, {"cellSpursInitialize", std::bind(&CellSpurs::cellSpursInitialize, &cellSpurs)}},
        {0xb8474eff,
         {"_cellSpursTaskAttributeInitialize", std::bind(&CellSpurs::_cellSpursTaskAttributeInitialize, &cellSpurs)}},
        ...
        {0xc0158d8b,
         {"cellSpursAddWorkloadWithAttribute", std::bind(&CellSpurs::cellSpursAddWorkloadWithAttribute, &cellSpurs)}},
        {0xc10931cb,
         {"cellSpursCreateTasksetWithAttribute",
          std::bind(&CellSpurs::cellSpursCreateTasksetWithAttribute, &cellSpurs)}},
        {0xc2acdf43,
         {"_cellSpursTasksetAttribute2Initialize",
          std::bind(&CellSpurs::_cellSpursTasksetAttribute2Initialize, &cellSpurs)}},
        {0xc765b995, {"cellSpursGetWorkloadFlag", std::bind(&CellSpurs::cellSpursGetWorkloadFlag, &cellSpurs)}},
        {0xd2e23fa9,
         {"cellSpursSetExceptionEventHandler", std::bind(&CellSpurs::cellSpursSetExceptionEventHandler, &cellSpurs)}},
        {0xe0a6dbe4, {"_cellSpursSendSignal", std::bind(&ModuleManager::stub, this)}},
        {0xefeb2679,
         {"_cellSpursWorkloadAttributeInitialize",
          std::bind(&CellSpurs::_cellSpursWorkloadAttributeInitialize, &cellSpurs)}},
        {0xf5507729, {"cellSpursEventFlagSet", std::bind(&ModuleManager::stub, this)}},

        {0x2cce9cf5,
         {"cellRtcGetCurrentClockLocalTime", std::bind(&CellRtc::cellRtcGetCurrentClockLocalTime, &cellRtc)}},
        ...
        {0x99406d0b, {"cellFsChmod", std::bind(&ModuleManager::stub, this)}},
        ...
        {0x04af134e,
         {"cellAudioCreateNotifyEventQueue", std::bind(&CellAudio::cellAudioCreateNotifyEventQueue, &cellAudio)}},
        ...
        {0xc01b4e7c,
         {"cellAudioOutGetSoundAvailability",
          std::bind(&CellAudioOut::cellAudioOutGetSoundAvailability, &cellAudioOut)}},
        {0xc3273d9b, {"cellAudioOutGetAvailableDeviceInfo", std::bind(&ModuleManager::stub, this)}},
        ...
        {0x2073b7f6, {"cellKbClearBuf", std::bind(&ModuleManager::stub, this)}},
        ...
        {0x4b9efb7a, {"sceNpManagerGetCachedInfo", std::bind(&ModuleManager::stub, this)}},
        ...
        {0xbdc07fd5, {"sceNpManagerGetNetworkTime", std::bind(&ModuleManager::stub, this)}},
        {0xbe07c708, {"sceNpManagerGetOnlineId", std::bind(&ModuleManager::stub, this)}},
        ...
        {0x370136fe,
         {"sceNpTrophyGetRequiredDiskSpace", std::bind(&SceNpTrophy::sceNpTrophyGetRequiredDiskSpace, &sceNpTrophy)}},
        ...
        {0xb3ac3478,
         {"sceNpTrophyGetTrophyUnlockState", std::bind(&SceNpTrophy::sceNpTrophyGetTrophyUnlockState, &sceNpTrophy)}},
        {0xe3bf9a28, {"sceNpTrophyCreateContext", std::bind(&SceNpTrophy::sceNpTrophyCreateContext, &sceNpTrophy)}},
        {0xff299e03, {"sceNpTrophyGetGameIcon", std::bind(&ModuleManager::stub, this)}},

        {0x21425307, {"cellSaveDataListAutoLoad", std::bind(&ModuleManager::stub, this)}},
        {0x248bd1d8,
         {"cellSaveDataUserListAutoLoad", std::bind(&CellSaveData::cellSaveDataUserListAutoLoad, &cellSaveData)}},
        ...
        {0x0ecd2261, {"cellGemUpdateStart", std::bind(&ModuleManager::stub, this)}},
        {0x13ea7c64, {"cellGemInit", std::bind(&ModuleManager::stub, this)}},
        {0x2e0a170d, {"cellGemGetMemorySize", std::bind(&ModuleManager::stub, this)}},
        {0x41ae9c31, {"cellGemUpdateFinish", std::bind(&ModuleManager::stub, this)}},
        {0x6441d38d, {"cellGemGetState", std::bind(&ModuleManager::stub, this)}},
        {0x9e1dff96, {"cellGemGetInfo", std::bind(&ModuleManager::stub, this)}},

        {0x02f5ced0, {"cellCameraStop", std::bind(&ModuleManager::stub, this)}},
        {0x379c5dd6, {"cellCameraClose", std::bind(&ModuleManager::stub, this)}},
        {0x58bc5870, {"cellCameraGetType", std::bind(&ModuleManager::stub, this)}},
        {0x5ad46570, {"cellCameraEnd", std::bind(&ModuleManager::stub, this)}},
        {0x7e063bbc, {"cellCameraIsAttached", std::bind(&ModuleManager::stub, this)}},
        {0xa7fd2f5b, {"cellCameraSetNotifyEventQueue2", std::bind(&ModuleManager::stub, this)}},
        {0xbf47c5dd, {"cellCameraInit", std::bind(&ModuleManager::stub, this)}},

        {0x0a563878, {"cellVoiceStart", std::bind(&ModuleManager::stub, this)}},
        {0x18d3df30, {"cellVoiceDisconnectIPortFromOPort", std::bind(&ModuleManager::stub, this)}},
        {0x2de54871, {"cellVoiceCreatePort", std::bind(&ModuleManager::stub, this)}},
        {0x54ac3519, {"cellVoiceGetPortInfo", std::bind(&ModuleManager::stub, this)}},
        {0x9d0f4af1, {"cellVoiceSetPortAttr", std::bind(&ModuleManager::stub, this)}},
        {0x9f70c475, {"cellVoiceDeletePort", std::bind(&ModuleManager::stub, this)}},
        {0xae6a21d5, {"cellVoiceConnectIPortToOPort", std::bind(&ModuleManager::stub, this)}},
        {0xbef53a2b, {"cellVoiceGetBitRate", std::bind(&ModuleManager::stub, this)}},
        {0xc7cf1182, {"cellVoiceInit", std::bind(&ModuleManager::stub, this)}},
        {0xe0e1ae12, {"cellVoiceEnd", std::bind(&ModuleManager::stub, this)}},

        {0x5c832bd7, {"cellUsbdSetThreadPriority2", std::bind(&ModuleManager::stub, this)}},
        {0x7fe92c54, {"cellUsbdRegisterExtraLdd", std::bind(&ModuleManager::stub, this)}},
        ...
        {0x224e1610, {"cellHttpClientSetRecvTimeout", std::bind(&ModuleManager::stub, this)}},
        {0x434419c8, {"cellHttpClientSetCookieStatus", std::bind(&ModuleManager::stub, this)}},
        {0x40547d8b, {"cellHttpClientSetVersion", std::bind(&ModuleManager::stub, this)}},
        {0x473cd9f1, {"cellHttpClientSetRedirectCallback", std::bind(&ModuleManager::stub, this)}},
        {0x5d473170, {"cellHttpClientSetKeepAlive", std::bind(&ModuleManager::stub, this)}},
        {0x660d42a9, {"cellHttpClientSetAuthenticationCallback", std::bind(&ModuleManager::stub, this)}},
        {0x71714cdc, {"cellHttpClientSetSendTimeout", std::bind(&ModuleManager::stub, this)}},
        {0xb6feb84b, {"cellHttpClientSetTransactionStateCallback", std::bind(&ModuleManager::stub, this)}},
        {0xcac9fc34, {"cellHttpClientSetUserAgent", std::bind(&ModuleManager::stub, this)}},
        ...
        {0xa50777c6,
         {"shutdown", std::bind(&ModuleManager::stub, this)}}, // This is libnet shutdown, not console shutdown
