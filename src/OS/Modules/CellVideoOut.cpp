...
u64 CellVideoOut::cellVideoOutGetState() {
    ...
    state->display_mode.aspect =
        (video_config.aspect != CELL_VIDEO_OUT_ASPECT_AUTO) ? video_config.aspect : CELL_VIDEO_OUT_ASPECT_16_9;
...
u64 CellVideoOut::cellVideoOutGetResolutionAvailability() {
    ...
    log("cellVideoOutGetResolutionAvailability(video_out: 0x%08x, res_id: 0x%08x, aspect: 0x%08x, option: 0x%08x) "
        "STUBBED\n",
        video_out,
        res_id,
        aspect,
