...
void SPUInterpreter::rotmai(const SPUInstruction& instr) {
    const s32 sh = (0 - ext<s32, 7>(instr.i7)) & 0x3f;
    state.gprs[instr.rt0].w[0] = isShOK<s32>(sh) ? (s32)state.gprs[instr.ra].w[0] >> sh : (s32)state.gprs[instr.ra].w[0] >> 31;
    state.gprs[instr.rt0].w[1] = isShOK<s32>(sh) ? (s32)state.gprs[instr.ra].w[1] >> sh : (s32)state.gprs[instr.ra].w[1] >> 31;
    state.gprs[instr.rt0].w[2] = isShOK<s32>(sh) ? (s32)state.gprs[instr.ra].w[2] >> sh : (s32)state.gprs[instr.ra].w[2] >> 31;
    state.gprs[instr.rt0].w[3] = isShOK<s32>(sh) ? (s32)state.gprs[instr.ra].w[3] >> sh : (s32)state.gprs[instr.ra].w[3] >> 31;
}
...
void SPUInterpreter::mpy(const SPUInstruction& instr) {
    state.gprs[instr.rt0].w[0] = (s32)(s16)(state.gprs[instr.ra].w[0] & 0xffff) * (s32)(s16)(state.gprs[instr.rb].w[0] & 0xffff);
    state.gprs[instr.rt0].w[1] = (s32)(s16)(state.gprs[instr.ra].w[1] & 0xffff) * (s32)(s16)(state.gprs[instr.rb].w[1] & 0xffff);
    state.gprs[instr.rt0].w[2] = (s32)(s16)(state.gprs[instr.ra].w[2] & 0xffff) * (s32)(s16)(state.gprs[instr.rb].w[2] & 0xffff);
    state.gprs[instr.rt0].w[3] = (s32)(s16)(state.gprs[instr.ra].w[3] & 0xffff) * (s32)(s16)(state.gprs[instr.rb].w[3] & 0xffff);
}

void SPUInterpreter::mpyh(const SPUInstruction& instr) {
    state.gprs[instr.rt0].w[0] = ((s32)(s16)(state.gprs[instr.ra].w[0] >> 16) * (s32)(s16)(state.gprs[instr.rb].w[0] & 0xffff)) << 16;
    state.gprs[instr.rt0].w[1] = ((s32)(s16)(state.gprs[instr.ra].w[1] >> 16) * (s32)(s16)(state.gprs[instr.rb].w[1] & 0xffff)) << 16;
    state.gprs[instr.rt0].w[2] = ((s32)(s16)(state.gprs[instr.ra].w[2] >> 16) * (s32)(s16)(state.gprs[instr.rb].w[2] & 0xffff)) << 16;
    state.gprs[instr.rt0].w[3] = ((s32)(s16)(state.gprs[instr.ra].w[3] >> 16) * (s32)(s16)(state.gprs[instr.rb].w[3] & 0xffff)) << 16;
}

void SPUInterpreter::mpyhh(const SPUInstruction& instr) {
    state.gprs[instr.rt0].w[0] = (s32)(s16)(state.gprs[instr.ra].w[0] >> 16) * (s32)(s16)(state.gprs[instr.rb].w[0] >> 16);
    state.gprs[instr.rt0].w[1] = (s32)(s16)(state.gprs[instr.ra].w[1] >> 16) * (s32)(s16)(state.gprs[instr.rb].w[1] >> 16);
    state.gprs[instr.rt0].w[2] = (s32)(s16)(state.gprs[instr.ra].w[2] >> 16) * (s32)(s16)(state.gprs[instr.rb].w[2] >> 16);
    state.gprs[instr.rt0].w[3] = (s32)(s16)(state.gprs[instr.ra].w[3] >> 16) * (s32)(s16)(state.gprs[instr.rb].w[3] >> 16);
}
