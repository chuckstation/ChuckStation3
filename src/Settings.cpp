...
void Settings::load() {
...
#ifdef __APPLE__
        fs::path pref_path               = SDL_GetPrefPath("ChuckStation", "ChuckStation3");
    ...
    if (!cfg.contains("System") || !cfg.contains("LLEModules") || !cfg.contains("Filesystem") ||
        !cfg.contains("Audio") || !cfg.contains("Debug")) {
        broken_config();
        return;
    }
